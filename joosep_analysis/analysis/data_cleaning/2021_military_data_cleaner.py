...
RAW_DATA_PATH = "C:\\Users\\joose\\Git_repos\\NATO_thesis\\joosep_analysis\\raw_data\\2021_Military_Balance_budget_personnel_report.csv"
CLEAN_DATA_PATH = "C:\\Users\\joose\\Git_repos\\NATO_thesis\\joosep_analysis\\clean_data\\2021_Military_Balance_budget_personnel_report_cleaned.csv"
...
df = pd.read_csv(RAW_DATA_PATH, skiprows=2, header=None)
...
df.columns = ["Country", "Defence budget per capita 2018", "Defence budget per capita 2019", "Defence budget per capita 2020", "Defence budget % GDP 2018", "Defence budget % GDP 2019", "Defence budget % GDP 2020", "Active Armed Forces 2020"]
...
int_cols = ["Defence budget per capita 2018", "Defence budget per capita 2019", "Defence budget per capita 2020", "Active Armed Forces 2020"]
float_cols = ["Defence budget % GDP 2018", "Defence budget % GDP 2019", "Defence budget % GDP 2020"]
...
inflation_factor = 237.0 / 271.0
per_capita_columns = [
    "Defence budget per capita 2018",
    "Defence budget per capita 2019",
